...
class IndexerBulkResource(BaseModel):
    ...
    prefer_magnet_url: Optional[StrictBool] = Field(default=None, alias="preferMagnetUrl")
    __properties: ClassVar[List[str]] = ["ids", "tags", "applyTags", "enable", "appProfileId", "priority", "minimumSeeders", "seedRatio", "seedTime", "packSeedTime", "preferMagnetUrl"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if self.prefer_magnet_url is None and "prefer_magnet_url" in self.model_fields_set:
