...
class IndexerBulkResource(BaseModel):
    ...
    reject_blocklisted_torrent_hashes_while_grabbing: Optional[StrictBool] = Field(default=None, alias="rejectBlocklistedTorrentHashesWhileGrabbing")
    __properties: ClassVar[List[str]] = ["ids", "tags", "applyTags", "enable", "appProfileId", "priority", "minimumSeeders", "seedRatio", "seedTime", "packSeedTime", "rejectBlocklistedTorrentHashesWhileGrabbing"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if reject_blocklisted_torrent_hashes_while_grabbing (nullable) is None
        # and model_fields_set contains the field
        if self.reject_blocklisted_torrent_hashes_while_grabbing is None and "reject_blocklisted_torrent_hashes_while_grabbing" in self.model_fields_set:
            _dict['rejectBlocklistedTorrentHashesWhileGrabbing'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rejectBlocklistedTorrentHashesWhileGrabbing": obj.get("rejectBlocklistedTorrentHashesWhileGrabbing")
        })
        return _obj
