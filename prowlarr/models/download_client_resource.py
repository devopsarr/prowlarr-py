...
class DownloadClientResource(BaseModel):
    ...
    supports_categories: Optional[StrictBool] = Field(default=None, alias="supportsCategories")
    __properties: ClassVar[List[str]] = ["id", "name", "fields", "implementationName", "implementation", "configContract", "infoLink", "message", "tags", "presets", "enable", "protocol", "priority", "categories", "supportsCategories"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "categories": [DownloadClientCategory.from_dict(_item) for _item in obj["categories"]] if obj.get("categories") is not None else None,
