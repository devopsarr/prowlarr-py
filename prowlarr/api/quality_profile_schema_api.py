...
class QualityProfileSchemaApi(object):
    ...
    @validate_arguments
    def get_appprofile_schema(self, **kwargs) -> AppProfileResource:  # noqa: E501
        """get_appprofile_schema  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_appprofile_schema(async_req=True)
        >>> result = thread.get()
        ...
        return self.get_appprofile_schema_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def get_appprofile_schema_with_http_info(self, **kwargs):  # noqa: E501
        """get_appprofile_schema  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_appprofile_schema_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method get_appprofile_schema" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
